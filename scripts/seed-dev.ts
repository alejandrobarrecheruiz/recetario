  ...
  return [
    {
      ...
      resumen: "Frio, de tomate maduro y sin trucos raros. El de todos los veranos.",
      estado: "publicada",
      visibilidad: "publica",
    ...
    },
    {
      ...
      resumen: "Jugosa por dentro y dorada por fuera. Con cebolla, sin pedir perdon.",
      estado: "publicada",
      visibilidad: "publica",
      ...
      ingredientes: [
        ...
        { id: "i4", cantidad: 400, unidad: "ml", nombre: "aceite de oliva", nota: "para freir" },
        { id: "i5", cantidad: 0, unidad: "", nombre: "sal", nota: "al gusto" },
      ],
      pasos: [
        { id: "p1", orden: 0, texto: "Pelar y cortar la patata en laminas finas; picar la cebolla.", imagenId: null },
        { id: "p2", orden: 1, texto: "Confitar patata y cebolla en aceite a fuego medio hasta que esten tiernas.", imagenId: null },
        { id: "p3", orden: 2, texto: "Escurrir bien y mezclar con el huevo batido y la sal. Reposar diez minutos.", imagenId: null },
        { id: "p4", orden: 3, texto: "Cuajar en sarten caliente, dar la vuelta con un plato y terminar al gusto.", imagenId: null },
      ],
    ...
    },
    {
      ...
      titulo: "Croquetas de jamon",
      resumen: "La bechamel de la abuela, con sus horas de carino y su reposo.",
      estado: "publicada",
      ...
      ingredientes: [
        { id: "i1", cantidad: 150, unidad: "g", nombre: "jamon iberico", nota: "picado fino" },
      ...
      pasos: [
        { id: "p1", orden: 0, texto: "Sofreir el jamon en la mantequilla sin que se dore.", imagenId: null },
        { id: "p2", orden: 1, texto: "Anadir la harina y cocinarla un par de minutos.", imagenId: null },
        ...
        { id: "p5", orden: 4, texto: "Formar, pasar por huevo y pan rallado, y freir en aceite bien caliente.", imagenId: null },
      ],
      notas: "Receta de familia: por eso es de las que solo ven los registrados.",
      seo: { descripcion: "Croquetas de jamon cremosas, con bechamel reposada." },
    },
    {
      ...base,
      _id: IDS.tarta,
      ...
      resumen: "Cremosa, casi liquida en el centro. Todavia ajustando el horno.",
      estado: "borrador",
      visibilidad: "publica",
      publicadaEn: null,
      raciones: 8,
      ...
      ingredientes: [
        ...
        { id: "i4", cantidad: 150, unidad: "g", nombre: "azucar" },
