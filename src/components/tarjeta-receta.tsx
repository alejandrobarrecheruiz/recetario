...
/** Una estructura para inicio, catálogo y cuenta; guardar nunca está dentro del enlace. */
export function TarjetaReceta({ receta, foto, guardada, haySesion, volverA, nivelTitulo = 2, accionGuardar, enlaceRef }: {
  ...
  return (
    <article className={`tarjeta-receta${foto ? "" : " tarjeta-receta-sin-foto"}`} aria-labelledby={`receta-${receta._id}`}>
