// TODO(fase 7): detalle de una receta.
//
...
//
// TODO(fase 8): JSON-LD de schema.org/Recipe y metadatos de SEO desde `seo`.
  ...
  return (
    <main className="mx-auto flex max-w-2xl flex-col gap-4 p-8">
      ...
      <p className="text-sm opacity-70">
        Andamiaje. El detalle de la receta llega en la fase 7.
      </p>
    </main>
  );
}
